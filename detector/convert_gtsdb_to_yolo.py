...
# ---- EDIT THESE PATHS IF YOUR EXTRACTED STRUCTURE DIFFERS ----
# Common layout after extracting FullIJCNN2013.zip:
# data/gtsdb_raw/FullIJCNN2013/*.ppm and data/gtsdb_raw/FullIJCNN2013/gt.txt
...
# 1-class detector: everything is "traffic_sign"
DET_CLASS_ID = 0
...
def main():
    ...
    boxes_by_img = {}
    for ln in lines:
        # GTSDB commonly: filename;left;top;right;bottom;classId
        parts = ln.split(";")
        img_name = parts[0]
